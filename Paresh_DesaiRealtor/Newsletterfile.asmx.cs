...
namespace Property
{
    ...
    public class Newsletterfile : System.Web.Services.WebService
    {
        ...
        public string EditableNewsLetterPrint(string NewsletterType, string FirstContent, string SecondContent, string ThirldContent)
        {
            string html = "";
            string Template = "";
            ...
            {
                Template = "PrintHtmlFiles/EditableFirstNewsLetter.html";
            }
